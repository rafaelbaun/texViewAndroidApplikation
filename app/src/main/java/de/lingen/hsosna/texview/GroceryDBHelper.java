...
public class GroceryDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_GROCERYLIST_TABLE = "CREATE TABLE " +
                ...
                GroceryContract.GroceryEntry.COLUMN_NAME + " TEXT NOT NULL, " + // STRING = TEXT
        ...
        final String SQL_CREATE_ARTIKELKOMBINATIONEN_TABLE = "CREATE TABLE " +
                TableArtikelkombination.ArtikelkombinationenEntry.TABLE_NAME + " (" +
                TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_ARTIKEL_ID + " INTEGER NOT NULL, " +
                TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_ARTIKEL_BEZEICHNUNG + " TEXT, " +
                TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_GROESSE_ID + " INTEGER NOT NULL, " +
                TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_FARBE_ID + " INTEGER NOT NULL, " +
                TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_FARBE_BEZEICHNUNGEN + " TEXT, " +
                "PRIMARY KEY(" + TableArtikelkombination.ArtikelkombinationenEntry.COLUMN_ARTIKEL_ID + ", "
        ...
        final String SQL_CREATE_LAGERBESTAND_TABLE = "CREATE TABLE " +
                ...
                "FOREIGN KEY(" + TableLagerbestand.LagerbestandEntry.COLUMN_LAGERPLATZ + ") REFERENCES "
                + TableLagerplaetze.LagerplaetzeEntry.TABLE_NAME + "(" + TableLagerplaetze.LagerplaetzeEntry.COLUMN_LAGERPLATZ + ") ON DELETE RESTRICT ON UPDATE CASCADE, " +

                "FOREIGN KEY(" + TableLagerbestand.LagerbestandEntry.COLUMN_ARTIKEL_ID + ", "
                                + TableLagerbestand.LagerbestandEntry.COLUMN_GROESSE_ID + ", "
                                + TableLagerbestand.LagerbestandEntry.COLUMN_FARBE_ID +
                ") REFERENCES "
                + TableArtikelkombination.ArtikelkombinationenEntry.TABLE_NAME + "("
        ...
        final String SQL_CREATE_LAGERPLAETZE_TABLE = "CREATE TABLE " +
                ...
                "PRIMARY KEY(" + TableLagerplaetze.LagerplaetzeEntry.COLUMN_LAGERPLATZ + ")" +
                ");";
